...
class YandexDiskUploader:
    ...
    def get_upload_url(self, filename):
        ...
        try:
            ...
            logging.info(UPLOAD_URL_ERROR.format(e))
            return None
    ...
    def upload_file(self, filename, file_data):
        ...
        if not upload_url:
            return False
        try:
            logging.info(f'Попытка загрузки файла')
    ...
    def get_download_url(self, file_path):
        ...
        try:
            ...
            logging.info(DOWNLOAD_URL_ERROR.format(e))
            return False
    ...
    def check_file_exists(self, file_path):
        ...
        try:
            ...
            logging.info(EXIST_ERROR.format(e))
            return False
